...
# «водой» (творительный) намеренно НЕ входит: в названии позиции оно почти
# всегда значит «что-то С водой» — «кофе, разбавленный водой», «американо с
# водой» — и считало бы кофе водой. Проверено на всех реальных названиях с прода.
_WATER_WORDS = {"вода", "воды", "воду", "water"}
