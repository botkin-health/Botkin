...
UPDATE users SET cohort = 'family',      pack_name = 'female-cycle' WHERE telegram_id = REDACTED_ID;
UPDATE users SET cohort = 'early_user',  pack_name = 'cardiac'      WHERE telegram_id = REDACTED_ID;
