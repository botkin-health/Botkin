#!/usr/bin/env python3
"""
Integration smoke tests — требуют живой PostgreSQL на сервере.
Запуск: pytest tests/smoke_test.py -m integration
...
if __name__ == "__main__":
    ...
    results = [test_database_connection(), test_garmin_last_date(), test_weekly_analysis(), test_nutrition_logs()]
