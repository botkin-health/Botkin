#!/usr/bin/env python3
"""
Live integration test — вызывает реальный GPT-4o API и читает локальные фото.
Требует: реального OPENAI_API_KEY и наличия тестовых фото на машине разработчика.
Запуск: pytest tests/test_live_llm.py -m integration
НЕ запускается в CI.
"""
...
def test_multiple_dishes_photo():
    ...
    images = [base_dir / "media__1772380978042.jpg", base_dir / "media__1772380980503.jpg"]
