...
description: Refactor and clean code using SOLID principles, clean-code practices, and design patterns. Use when refactoring functions/modules, reducing complexity, removing duplication, or modernizing legacy code. See references/tech-debt.md for tech-debt assessment.
source: https://github.com/wshobson/agents/tree/main/plugins/code-refactoring (commands/refactor-clean.md)
---
