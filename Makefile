...
db-backfill-garmin:
	...
	@DATABASE_URL=postgresql://healthvault:***REMOVED***@localhost:5432/healthvault $(PYTHON) scripts/backfill_garmin.py 30

# Check today's data in DB
db-check-today:
	@echo "🔎 Checking today's data in DB..."
	@DATABASE_URL=postgresql://healthvault:***REMOVED***@localhost:5432/healthvault $(PYTHON) scripts/check_today_data.py
