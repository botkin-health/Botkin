...
def update_weights_json(weight_records):
    ...
    data["entries"] = sorted(data["entries"] + new_entries, key=lambda x: x["date"], reverse=True)
...
def compare_with_smart_scale(
    weights_data, smart_scale_weight=81.90, smart_scale_date="2026-01-08", smart_scale_time="13:16"
):
