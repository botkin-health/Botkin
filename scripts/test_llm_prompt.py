...
TEST_CASES = [
    ...
    # ----------------------------------------------------------
    # ГРУППА 4: Упаковки готовых продуктов (packaging)
    # Регрессия: Bombbar Slim Nuts 35г — бот вернул 229 ккал (визуальный ореховый батончик)
    # вместо правильных ~116 ккал (протеиновый батончик)
    # ----------------------------------------------------------
    {
        "name": "Упаковка протеинового батончика Bombbar Slim Nuts 35г [регрессия]",
        "tags": ["label", "packaging", "regression"],
        "text": (
            "Фото обёртки батончика: Bombbar Slim Nuts, "
            "Net Weight 35g, надпись '30% PROTEIN', HIGH FIBER, NO SUGAR ADDED"
        ),
        "expect_type": "food",
        "calories": (90, 140),   # правильно ~116 ккал
        "bad_value": 229,         # бот вернул 229 (визуальная оценка как ореховый батончик)
        "notes": (
            "Bombbar Slim Nuts 35г: ~116 ккал, Б:10г, Ж:3г, У:4г. "
            "Не путать с обычным ореховым батончиком (~229 ккал, Б:5г, Ж:23г)."
        ),
    },
]
