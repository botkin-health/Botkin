...
Usage:
    ...
    python scripts/import_blood_pressure.py --db-url postgresql://healthvault:***REMOVED***@116.203.213.137:5432/healthvault
...
def main():
    ...
    parser.add_argument(
        "--db-url",
        default=os.getenv("DATABASE_URL", "postgresql://healthvault:***REMOVED***@116.203.213.137:5432/healthvault"),
