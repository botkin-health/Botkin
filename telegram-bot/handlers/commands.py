...
# главный сценарий — медицинский Q&A с агентом (а не трекинг еды). Стандартное
# приветствие про еду на «ты» сбивает с толку. Ключ — telegram_id.
PERSONAL_START_GREETINGS = {
    # Валерия Лысковская (мама Александра) — кардио-профиль, общение на «вы»
    5162726004: (
        "👋 Здравствуйте, Валерия!\n\n"
        "Я <b>Botkin</b> — ваш личный помощник по здоровью. Меня подключил Саша, и я "
        "уже изучил всю вашу медицинскую историю. Ничего настраивать или загружать "
        "не нужно — я готов помогать прямо сейчас.\n\n"
        "<b>Что я про вас знаю:</b>\n"
        "• Все ваши анализы крови с 2009 по 2026 год — холестерин, сахар, печёночные "
        "и десятки других показателей, и как они менялись\n"
        "• Ваши диагнозы и историю — сердце и давление, щитовидную железу, операцию "
        "2015 года и наблюдение после неё\n"
        "• Лекарства, которые вы принимаете, и те, что вам не подошли\n"
        "• Дневник давления, который вы вели весной\n\n"
        "<b>С чем можно ко мне обращаться</b> — пишите обычными словами, текстом или "
        "голосом:\n\n"
        "🩺 <b>Здоровье, анализы, диагнозы</b>\n"
        "• «Какой у меня сейчас холестерин и не опасно ли это?»\n"
        "• «Что означает мой последний анализ?»\n"
        "• «У меня кружится голова / отекают веки — на что обратить внимание?»\n"
        "• «Какие обследования мне стоит обсудить с врачом?»\n\n"
        "🥗 <b>Питание</b>\n"
        "• «Какие продукты мне полезны, а какие лучше ограничить?»\n"
        "• «Что приготовить на завтрак при моём холестерине?»\n"
        "• «Можно ли мне солёное или сладкое?»\n\n"
        "🚶 <b>Активность и образ жизни</b>\n"
        "• «Полезна ли мне ходьба, лыжи, велосипед — и сколько?»\n"
        "• «Как двигаться, чтобы не навредить сердцу и спине?»\n"
        "• «Что поможет мне быть бодрой и в хорошем настроении?»\n\n"
        "Я отвечаю спокойно и по делу, простым языком. Я — помощник, а не замена "
        "врачу: важные решения всегда остаются за вами и вашим кардиологом Юлией "
        "Андреевной.\n\n"
        "🌐 Ваш дашборд со всеми показателями:\n"
        "https://botkin.health/mc/06f7c19621c3089a0adc5c3cb6f32228"
    ),
}
